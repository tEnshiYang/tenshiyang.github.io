...
(function() {
    ...
    KeyEvent.addListener = function() {
        document.ontouchstart = function (e) {
          console.log(e);
          const leftInstance = e.touches[0].pageX;
          const screenWidth = window.innerWidth;
          if (leftInstance < (screenWidth / 2)) {
            KeyEvent.__keyDownMap[37] = true;
          } else {
            KeyEvent.__keyDownMap[39] = true;
          }
        }
        document.ontouchend = function (e) {
          console.log(e);
          const leftInstance = e.changedTouches[0].pageX;
          const screenWidth = window.innerWidth;
          if (leftInstance < (screenWidth / 2)) {
            KeyEvent.__keyDownMap[37] = false;
          } else {

            KeyEvent.__keyDownMap[39] = false;
          }
        }
